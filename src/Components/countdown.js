...
const COUNTDOWN_TARGET = new Date("2024-09-30T08:15:59");
...
const Countdown = () => {
	...
	return (
		...
		<p>We are pleased to announce the successful cut over of Jara Stores at Ikeja, Ibadan, Oyo, Ado-Ekiti, Benin City (Ugbowo and Sakponba) and Shoprite Stores at The Palms, Lekki Mall, Circle Mall, Adeniran Ogunsanya, Ikeja City Mall, Festival Mall, Park Lane, Ota Gateway, Cocoa Mall, Ibadan Mall, Akure Mall, Kwara Mall, Grand Tower, Gateway, Jabilake Mall, Silverbird Mall, Galaxy Mall, Garden City Mall, Owerri Mall, Abia Mall, Enugu Mall, Onitsha Mall, Asaba Mall, and Delta Mall to the new ERP. <div className='boldy' >Shoprite Delta Mall has been live for:</div> </p>
