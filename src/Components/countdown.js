...
const COUNTDOWN_TARGET = new Date("2024-08-14T13:59:59");
...
const Countdown = () => {
	...
	return (
		...
		{/* <p>We are pleased to announce the successful cut over of Jara Stores at Ikeja, Ibadan, Oyo, Ado-Ekiti, Benin City (Ugbowo and Sakponba) and Shoprite Stores at The Palms, Lekki Mall, Circle Mall, Adeniran Ogunsanya, Ikeja City Mall, Festival Mall, Park Lane, Ota Gateway, Cocoa Mall, Ibadan Mall, Akure Mall, Kwara, and Grand Tower Mall to the new ERP. <div className='boldy' >Shoprite Grand Tower Mall has been live for:</div> </p> */}
		<p>We are pleased to announce the successful cut over of Jara Stores at Ikeja, Ibadan, Oyo, Ado-Ekiti, Benin City (Ugbowo and Sakponba) and Shoprite Stores at The Palms, Lekki Mall, Circle Mall, Adeniran Ogunsanya, Ikeja City Mall, Festival Mall, Park Lane, Ota Gateway, Cocoa Mall, Ibadan, Akure, Kwara Mall, and Grand Tower Mall to the new ERP.
	     <div className='boldy' > Shoprite Gateway Mall is scheduled to go live in:</div></p>
