...
// const COUNTDOWN_TARGET = new Date("2024-06-18T09:59:59");
const COUNTDOWN_TARGET = new Date("2024-06-19T11:59:59");
...
const Countdown = () => {
	...
	return (
		...
		<p>We are pleased to announce the successful transition of Jara Ikeja, Jara Ibadan, Jara Oyo, Jara Ekiti, Jara Ugbowo Stores to the new ERP. <span className='boldy' >Next, Jara Sakponba is expected to go live in:</span></p>
