...
// const COUNTDOWN_TARGET = new Date("2024-06-11T11:59:59");
const COUNTDOWN_TARGET = new Date("2024-06-13T11:59:59");
...
const Countdown = () => {
	...
	return (
		...
		<p>We are pleased to announce the successful transition of Jara Ibadan Store to the new ERP. The store has been live for: </p> */}
		<p>We are pleased to announce the successful transition of Jara Ikeja, Jara Ibadan to the new ERP. Next, Jara Oyo is expected to be live in:</p>
